            ...
            >
              <form onSubmit={handleSubmit}>
                <div className="flex flex-col space-y-1.5 p-6">
                  <h1 className="whitespace-nowrap font-semibold tracking-tight text-4xl">
                    여행 의뢰 작성
                  </h1>
                </div>
                <div className="p-6 grid gap-8">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="grid gap-4">
                      <label className="font-medium text-lg" htmlFor="end-date">
                        여행 종료일
                      </label>
                      <input
                        min={
                  ...
                  <div className="flex justify-end gap-4">
                    <button
                      className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium border border-input bg-white hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2  hover:bg-blue-200 dark:hover:bg-gray-700"
                      onClick={returnList}
                    >
                      작성 취소
                    </button>
                    <button
                      className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium bg-white text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2  hover:bg-blue-200 dark:hover:bg-gray-700"
                      type="submit"
                    >
                      작성 완료
                    </button>
