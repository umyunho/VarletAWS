...
function Join() {
  ...
  async function onSubmit() {
    ...
    try {
      let result = await axios.post("/api/member/useridCheck", null, {
        params: { userid },
      });
      ...
      result = await axios.post("/api/member/nicknameCheck", null, {
        params: { nickname },
      });
      if (result.data.msg === "no") {
            ...
            >
              ...
              <div className="flex items-center space-x-2 justify-between">
                ...
                <button
                  ...
                  className="w-2/5 h-10 text-white bg-gradient-to-r from-[#1e90ff] to-[#1e90ff] rounded-lg"
                >
                  우편번호 찾기
                </button>
              </div>
              ...
              <div className="flex items-center space-x-2 justify-between">
                ...
                <input
                  ...
                  value={d_address}
                  onChange={(e) => {
                    setD_address(e.currentTarget.value);
                  }}
                />
              </div>
              <div className="flex items-center space-x-2 justify-between">
              ...
              <div className="w-full">
                <div>
                  <img
                    ...
                    style={imgStyle}
                    onError={() =>
                      console.error("Failed to load image:", profileimg)
                    }
                  />
                </div>
              </div>
