        ...
        <div className="contents-container flex flex-wrap justify-between">
          ...
          {Array.isArray(filteredContents) && filteredContents.length > 0 ? (
            filteredContents.map((contents, idx) => (
              <div
                className="bg-white w-1/5 p-4 rounded-lg overflow-hidden shadow-lg transition-all hover:scale-105"
                key={idx}
                onClick={() => {
              ...
              >
                ...
                <div className="p-4">
                  ...
                  {contents.ctype === "축제" && (
                    <p className="text-muted-foreground mb-4">
                      {contents.cstart_time.substring(0, 10)} -{" "}
                      {contents.cend_time.substring(0, 10)}
                    </p>
                  )}
