...
// 답글과 관련된 파일을 저장하는 서비스 메소드
    @Transactional
    public Rcrecommend saveRcrecommend(Rcrecommend rcrecommend, MultipartFile[] files, HashMap<String, String> allParams, Member member) throws IOException {
        // 답글을 데이터베이스에 저장
        ...
        if (files != null && files.length > 0) {
            ...
            is.saveFiles(files, member, rcrecommend, allParams);
        }
